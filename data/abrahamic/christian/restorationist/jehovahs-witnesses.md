...
summary: >-
  A millenarian Christian-origin movement descending from Charles Taze Russell's
  Bible Student networks.
canonical_texts:
...
origin_geo:
  lat: 40.45
  lng: -80.0167
  place_name: 'Allegheny (Pittsburgh), Pennsylvania, USA'
extinct_year: null
key_tenets:
  - >-
...
artifacts:
  - title: Jehovah's Witnesses Historical Reference & Architecture
    url: 'https://en.wikipedia.org/wiki/Jehovah''s_Witnesses'
    provenance: Scholarly & Archaeological Archives
    period: Historical Origin to Modern Era
    description: >-
      Authoritative historical documentation, primary sources, and material
      culture associated with Jehovah's Witnesses.
  - title: Jehovah's Witnesses Primary Texts & Sacred Records
    url: 'https://en.wikipedia.org/wiki/New_World_Translation_of_the_Holy_Scriptures'
