---
id: parsi-zoroastrianism
title: Parsi Zoroastrianism
cluster: Iranian
color: '#edbb18'
era_start: c. 8th–10th century CE
epistemic_tier: academic_consensus
summary: >-
  The Zoroastrian community of the Indian subcontinent, formed through migration
  from Iran and centuries of South Asian development.
aliases:
  - Parsi religion
...
canonical_texts:
  ...
  - Qissa-i Sanjan
  - Persian Rivayats
  - Parsi liturgical books
relations:
  - target: zoroastrianism
    type: branch_of
    certainty: academic_consensus
  - target: sasanian-zoroastrianism
    type: influenced_by
    certainty: academic_consensus
origin_year: 750
origin_geo:
...
artifacts:
  - title: "Pundole Agiary near the Iranshah Atash Behram in Udvada, Gujarat"
    ...
    provenance: "Rayomand Ichhaporia; CC BY-SA 3.0"
    period: "Image dated 2005"
  - title: "Parsi child seated during the sacred Navjote initiation ceremony"
    imageUrl: "/artifacts/parsi-zoroastrianism-2.webp"
    sourceUrl: "https://commons.wikimedia.org/wiki/File:Parsi-navjote-sitting.jpg"
    provenance: "Unknown photographer; CC BY-SA 3.0"
...
Zoroastrian migrants from Iran established enduring communities in western India, conventionally narrated in the later *Qissa-i Sanjan*. Precise dates and details of migration remain debated. Under Gujarati, Mughal, and British rule, Parsis developed distinctive institutions, occupational networks, charitable trusts, priestly lineages, and major urban communities, especially in Bombay.

## Community and distinction

Parsis preserve Avestan liturgy, fire temples, initiation, purity disciplines, and funerary customs while reflecting a specifically South Asian history. Debates over conversion, intermarriage, calendar, reform, and identity are internal and ongoing. “Parsi” is an ethnoreligious community name; it is not interchangeable with all Zoroastrians, including the related Iranian community.
