...
- **In-App Display**: The OpenGrail interface surfaces provenance, period, and source links for each artifact directly within the Document Pane and Lightbox views.

No rights beyond those granted by the original upstream authors and licenses (such as Public Domain, CC0, CC-BY, or CC-BY-SA) are granted for any image asset under `public/artifacts/`.
